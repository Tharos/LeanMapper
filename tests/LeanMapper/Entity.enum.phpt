...
}, 'LeanMapper\Exception\InvalidValueException', "Value 'superactive' is not from possible values enumeration.");
...
}, 'LeanMapper\Exception\InvalidValueException', "Value 'active' is not from possible values enumeration.");
